...
pub trait DisplayMemoryMap {
    ...
    fn line_width(&self, y: u8) -> u8;

    /// Size of the physical display.
    fn display_size(&self) -> (u8, u8);

    /// Whether the display uses two memory lines.
    fn has_two_memory_lines(&self) -> bool;
}
